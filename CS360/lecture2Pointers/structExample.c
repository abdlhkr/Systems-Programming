...
int main()
{
    ...
    // so that you don't waste too much memory. If you don't care about memory, don't worry about it
    //  (or just keep writing programs in Python.....)
    // I am happy that I am not the only person who takes silly notes rfneosvar
    return 0;
}